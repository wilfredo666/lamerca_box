              ...
              <tr>
                ...
                <td class="usuarios-acciones">
                  <button class="btn btn-sm btn-primary btn-editar-usuario" data-toggle="modal" data-target="#modalUsuario"
                    ...
                    data-estado="<?= (int) $usuario["estado_usuario"] ?>"><i class="fas fa-edit"></i>
                  </button>
                  ...
                  <a href="<?= $base_url ?>usuarios/permisos?id=<?= (int) $usuario["id_usuario"] ?>" class="btn btn-sm btn-default" title="Gestionar permisos" aria-label="Gestionar permisos de <?= $h($usuario["nombre"]) ?>"><i class="fas fa-unlock"></i></a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
...
<script>
  window.usuariosBaseUrl = <?= json_encode($base_url) ?>;
</script>
  ...
  <div class="modal-dialog">
    <form method="POST" class="modal-content" id="formUsuario">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="tituloModalUsuario">Nuevo usuario</h5><button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        ...
        <div class="form-group mb-0"><label>Estado</label><select id="estadoUsuario" name="estado" class="form-control">
