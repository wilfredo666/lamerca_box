    ...
    <div class="row">
        ...
        <div class="card-body">
          ...
          <article class="tarjeta-encomienda" data-id="<?= (int) $encomienda["id"] ?>" data-destinatario="<?= $h($encomienda["destinatario"]) ?>" data-descripcion="<?= $h($encomienda["descripcion"] ?: "Sin descripción") ?>" data-codigo="<?= $h($encomienda["codigo"]) ?>" data-precio="<?= number_format((float) ($encomienda["precio"] ?? 2), 2, ".", "") ?>" data-quien-paga="<?= $h($encomienda["quien_paga"]) ?>" data-fecha-registro="<?= $h($encomienda["fecha_registro"]) ?>">
            ...
            <label class="selector-encomienda" aria-label="Seleccionar encomienda" style="display:none">
              <input type="checkbox" class="selectorEncomienda" value="<?= (int) $encomienda["id"] ?>" <?= $encomienda["estado"] === "Pendiente" ? "" : "disabled" ?> checked>
            </label>
      ...
      <div class="col-md-6">
        <div class="card-body text-center">
          ...
          <div>
            <img src="<?= $base_url . "assets/img/paquetes/" . rawurlencode(basename($encomienda["foto"])) ?>" alt="Foto de la encomienda" class="w-100 rounded" style="max-height:100%; object-fit:cover;">
          </div>
          <?php else: ?>
